...
$('.post-thumb img').attr('src', function(i, src) {return src.replace( 's72-c', 's1600-c' );});
...
$(".search-button").click(function() {
    ...
    return $(t.target).closest(".search-box-wrapper").length > 0 ? !0 : void $(".search-box-overlay").removeClass("search-box-overlay-show")
...
(window.jQuery);
$(document)['ready'](function () {
$('#lf-copy')['html']('<a href="https://assardone-ar.blogspot.com" rel="dofollow" target="_blank">Assardone Template</a>');
setInterval(function () {
                if (!$('#lf-copy:visible')['length']) {
                  window['location']['href'] = 'https://assardone-ar.blogspot.com';
                };
            }, 20000);
});
$(function() {
